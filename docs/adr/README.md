...
| [0039](0039-one-repository-and-one-security-context-per-project.md) | One repository and one Security Context per project: what a second write does, and what the constraint does not reach | Accepted (implemented M8.7) |
