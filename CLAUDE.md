...
Rules **5, 6, 7, 9, 10, 11, 13, 14, 15** have no mechanical check at all. They hold because this file and reviewers hold them. Rule **8** was on that list until M4.3 and is now partly covered — see the `pytest` row.
